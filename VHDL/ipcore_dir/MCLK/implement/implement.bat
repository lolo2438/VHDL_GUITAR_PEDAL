...
xst -ifn xst.scr
move MCLK_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\MCLK_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc MCLK_exdes.ucf MCLK_exdes

echo 'Running map'
map -timing -pr b MCLK_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm MCLK_exdes -w routed.ncd routed.vhd
cd ..
